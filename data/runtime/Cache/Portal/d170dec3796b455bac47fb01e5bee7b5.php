...
<html>
	<head>
		...
		<link rel="stylesheet" href="/tpl/simplebootx/Public/css/rule.css" type="text/css">
	...
	<body>
		...
		<div class="banner"><img src="/tpl/simplebootx/Public/images/ruleAd.gif" alt="" /></div>
		<div class="layout">
			<div class="ad_1  mt15"><img src="/tpl/simplebootx/Public/images/ad_1_1.gif"/></div>
			<div class="ad_2"><a href="<?php echo U('Login/reg');?>"><img src="/tpl/simplebootx/Public/images/fxRegist.png"/></a></div>
			<div class="ad_3"><img src="/tpl/simplebootx/Public/images/ad_1_3.gif" alt="" /></div>
		</div>
	  <div class="footer">
      <p class="p1">
          <a href="#">关于我们</a>&nbsp;|
...
<script type="text/javascript">
	$(function(){
		...
		$(".menubar ul li").eq(3).addClass("active").siblings().removeClass("active");
